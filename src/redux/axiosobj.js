...
const getNiceNews = async () => {
  const response = await axios.get('https://cors-anywhere.herokuapp.com/corsdemo/http://api.steampowered.com/ISteamNews/GetNewsForApp/v0002/', {
    params: {
        'appid': '440'
    }
  });
